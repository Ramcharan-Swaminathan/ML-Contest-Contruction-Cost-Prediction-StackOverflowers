...
def extract_embeddings_tta(df, image_dir):
    ...
    # Load PCA model
    if not os.path.exists('pca_model_09.pkl'):
        raise FileNotFoundError("PCA model 'pca_model_09.pkl' not found! Run train_09_random.py first.")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_path', type=str, default='submission009.csv')
    parser.add_argument('--model_path', type=str, default='model_checkpoint_09.txt')
